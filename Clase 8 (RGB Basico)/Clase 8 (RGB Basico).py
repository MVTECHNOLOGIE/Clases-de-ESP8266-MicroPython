...
Rojo  = Pin(4, Pin.OUT)     #Declaramos que la variable "Rojo" Perteneciente al pin 4 y quedara como salida "OUTPUT"
Verde = Pin(14, Pin.OUT)    #Declaramos que la variable "Verde" Perteneciente al pin 14 y quedara como salida "OUTPUT"
Azul  = Pin(15, Pin.OUT)    #Declaramos que la variable "Azul" Perteneciente al pin 15 y quedara como salida "OUTPUT"


while True:                #Declaramos el bucle infinito
    Rojo.value(1)          #Indicamos que el pin 4 deberá estar en alto "HIGH" o "1"
    Verde.value(0)         #Indicamos que el pin 14 deberá estar en bajo "LOW" o "0"
    Azul.value(0)          #Indicamos que el pin 15 deberá estar en bajo "LOW" o "0"
    time.sleep(1)          #Colocamos un tiempo de espera de 1 segundo
    
    Rojo.value(0)          #Indicamos que el pin 4 deberá estar en bajo "LOW" o "0"
    ...
    Rojo.value(0)          #Indicamos que el pin 4 deberá estar en bajo "LOW" o "0"
    Verde.value(0)         #Indicamos que el pin 14 deberá estar en bajo "LOW" o "0"
    Azul.value(1)          #Indicamos que el pin 15 deberá estar en alto "HIGH" o "1"
    time.sleep(1)          #Colocamos un tiempo de espera de 1 segundo